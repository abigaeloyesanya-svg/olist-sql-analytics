...
queries folder contains olist_sql_analytics.sql, all four queries, commented with business rationale

images folder contains retention_chart.png, the chart summarizing the core finding
...
Full project write up on Notion
